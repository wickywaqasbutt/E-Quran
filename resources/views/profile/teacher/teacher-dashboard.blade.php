...
<head>
    ...
    <title>E-Quran || Teacher Dashboard</title>
    <!-- Custom CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('profile.show') }}
                                   " aria-expanded="false">
                                <i class="ti-settings"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('userDashboard') }}
                                   " aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('appliedStudents') }}
                                   " aria-expanded="false">
                                <i class="fas fa-user"></i>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('inviteStudents') }}
                                   " aria-expanded="false">
                                <i class="fas fa-user"></i>
                                <span class="hide-menu">Invite Students</span>
                            </a>
                        </li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="m-b-0 font-light">13</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="m-b-0 font-light">$ 13,000</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">All Students listed below</h5>
                                    </div>
                                </div>
                                <!-- title -->
                            </div>
                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            ...
                                            <th class="border-top-0">Chat</th>
                                            <th class="border-top-0">Video Call</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="">
                                                        <h4 class="m-b-0 font-16">{{$i->name}}</h4>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{$i->email}}</td>
                                            <td>
                                                <label class="label label-basic">{{$i->course}}</label>
                                            </td>
                                            <td>
                                                <span class="btn btn-circle btn-md btn-info">
                                            ...
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-success">
                                                    <a href="skype:{{$i->skype}}?call">
                                                        <i class="fas fa-phone-square text-white"></i>
                                                    </a>
                                                </span></center>
                                            </td>
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('removeStudent', $i->id)}}">
