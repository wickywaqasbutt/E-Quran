                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">Requested Students</h4>
                                        <h5 class="card-subtitle">All Requested Students listed below</h5>
                                    </div>
                                </div>
                                <!-- title -->
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-success">
                                                    <a href="{{route('acceptStudent', $i->id)}}">
                                            ...
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('declineStudent', $i->id) }}">
