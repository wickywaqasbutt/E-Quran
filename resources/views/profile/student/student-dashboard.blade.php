...
<head>
    ...
    <title>E_QURAN || Student Dashboard</title>
    <!-- Custom CSS -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">Request a teacher given below</h5>
                                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$i->email}}</td>
                                            <td>
                                                <label class="label label-success">{{$i->course}}</label>
                                            </td>
                                            <td>
                                                <span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('applyTeacher', $i->id)}}">
                                ...
                                @elseif(Auth::user()->apply == Null && Auth::user()->team_id == 0)
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            <th class="border-top-0">Name</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('acceptTeacher', $i->id) }}">
                                                        <i class="fas fa-check text-white"></i>
                                                    </a>
                                                </span></center>
                                            </td>
                                            <td>
                                                <center><span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('declineTeacher', $i->id) }}">
                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="btn btn-circle btn-md btn-danger">
                                                    <a href="{{route('cancelRequest', $i->id) }}">
                                                        <i class="fas fa-window-close text-white"></i>
                                                    </a>
                                                </span>
                                            </td>
