                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium">Sign In to Avail Service</h5>
                                    <a href="{{url('signup') }}" title="signup" class="btn btn-circle btn-sm">
                                        <i class="fas fa-user-plus"></i>
                                    </a>
                                    <a href="{{url('login') }}" title="login" class="btn btn-circle btn-sm">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('signup') }}
                                   " aria-expanded="false">
                                <i class="fas fa-user-plus"></i>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{route('teacherHifz')}}" class="sidebar-link">
                                        <i class="mdi mdi-toggle-switch"></i>
                                        <span class="hide-menu"> Hifz</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{route('teacherTajweed')}}" class="sidebar-link">
                                        <i class="mdi mdi-tablet"></i>
                                        <span class="hide-menu"> Tajweed</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{route('teacherArabic')}}" class="sidebar-link">
                                        <i class="mdi mdi-tablet"></i>
                                        <span class="hide-menu"> Arabic</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{route('teacherQirat')}}" class="sidebar-link">
                                        <i class="mdi mdi-tablet"></i>
                                        <span class="hide-menu"> Qirat</span>
                                    </a>
                                </li>
                                 <li class="sidebar-item">
                                    <a href="{{route('teacherQirat')}}" class="sidebar-link">
                                        <i class="mdi mdi-tablet"></i>
                                        <span class="hide-menu"> Translation & tafseer</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Sign In to Avail Services</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">Available Teachers</h4>
                                        <h5 class="card-subtitle">Register Yourself to Contact Instructors</h5>
                                    </div>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-1">Course: {{$i->course}}</h5><br>
                                                    <h5 class="mt-0 mb-1">Description:</h5>{{$i->description}}
                                                    <br><br>
                                                    <h5 class="mt-0 mb-1">Sample Audio:</h5>
                                                    <audio controls>
                                                      <source src="storage/uploads/audio/{{$i->audio}}" type="audio/ogg">
                                                      <source src="storage/uploads/audio/{{$i->audio}}" type="audio/mpeg">
