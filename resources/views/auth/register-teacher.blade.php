<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <center><h2 style="background: lightblue;">TUTOR REGISTRATION FORM</h2></center><br>
...
<div class="mt-4">
            ...
            <div class="mt-4">
                <x-jet-label for="audio" value="{{ __('Upload Sample Audio') }}" />
                <x-jet-input id="audio" class="block mt-1 w-full" type="file" name="audio" required autocomplete="audio" />
            </div>
